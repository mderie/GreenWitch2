...
public:
	...
	virtual void buttonClicked(Button *sender) override; // Care all checkboxes are in fact toggle button !
...
private:
	...
	ToggleButton chkMuteIn0;
	//ToggleButton chkMuteOut0;
	...
	ToggleButton chkMuteIn1;
	//ToggleButton chkMuteOut1;
	...
	ToggleButton chkMuteIn2;
	//ToggleButton chkMuteOut2;
	...
	ToggleButton chkMuteIn3;
	//ToggleButton chkMuteOut3;
	...
	byte m_midiInByte0;
	byte m_midiInHighNibble0;
	byte m_midiInLowNibble0;
	byte m_midiInByte1;
	byte m_midiInHighNibble1;
	byte m_midiInLowNibble1;
	byte m_midiInByte2;
	byte m_midiInHighNibble2;
	byte m_midiInLowNibble2;

	byte m_midiOutByte0;
	byte m_midiOutHighNibble0;
	byte m_midiOutLowNibble0;
	byte m_midiOutByte1;
	byte m_midiOutHighNibble1;
	byte m_midiOutLowNibble1;
	byte m_midiOutByte2;
	byte m_midiOutHighNibble2;
	byte m_midiOutLowNibble2;
